...
fun World.dropItem(location: Location, blockData: BlockData): Item {
    return dropItem(location, blockData.material.asItemStack())
}
...
fun World.dropItemNaturally(location: Location, blockData: BlockData): Item {
    return dropItemNaturally(location, blockData.material.asItemStack())
}
