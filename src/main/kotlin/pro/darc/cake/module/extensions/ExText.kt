...
fun CommandSender.sendMessage(text: BaseComponent) = (this as? Player)?.sendMessage(text) ?: sendMessage(TextComponent.toLegacyText(text))
fun CommandSender.sendMessage(text: Array<BaseComponent>) = (this as? Player)?.sendMessage(text) ?: sendMessage(TextComponent.toLegacyText(*text))
